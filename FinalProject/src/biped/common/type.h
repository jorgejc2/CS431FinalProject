...
struct ActuationCommand
{
    ...
    ActuationCommand(bool motor_enable_, bool motor_left_forward_, bool motor_right_forward_, double motor_left_pwm_, double motor_right_pwm_) : motor_enable(motor_enable_), motor_left_forward(motor_left_forward_), motor_right_forward(motor_right_forward_),
            motor_left_pwm(motor_left_pwm_), motor_right_pwm(motor_right_pwm_)
    {
    }
};
