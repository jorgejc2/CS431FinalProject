...
constexpr double calibration_controller_reference = 3.5; //!< Compass calibration controller reference.
}   // namespace CompassParameter
...
constexpr double attitude_y_active = 25; //!< Maximum Y attitude for controller to remain active, in degrees.
/* att y: Kp = -3000, Kd = -40 */
/* position x: Kp = 2000, Kd = 1000 */
/* DEBUG 
 * Using reference minus state instead yields
 * att y: Kp = 3000; Kd = -40
 * position x: Kp = -2000; Kd = 1000
*/
/*
